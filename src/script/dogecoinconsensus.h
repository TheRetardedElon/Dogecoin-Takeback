...
#ifndef DOGECOIN_DOGECOINCONSENSUS_H
#define DOGECOIN_DOGECOINCONSENSUS_H
...
enum
{
    ...
    dogecoinconsensus_SCRIPT_FLAGS_VERIFY_ALL                 = dogecoinconsensus_SCRIPT_FLAGS_VERIFY_P2SH | dogecoinconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
                                                               dogecoinconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY | dogecoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY |
                                                               dogecoinconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY | dogecoinconsensus_SCRIPT_FLAGS_VERIFY_WITNESS
};
...
EXPORT_SYMBOL int dogecoinconsensus_verify_script_with_amount(const unsigned char *scriptPubKey, unsigned int scriptPubKeyLen, int64_t amount,
                                    const unsigned char *txTo        , unsigned int txToLen,
                                    unsigned int nIn, unsigned int flags, dogecoinconsensus_error* err);
...
#endif // DOGECOIN_DOGECOINCONSENSUS_H
